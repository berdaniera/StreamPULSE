            ...
            fluidRow(
                column(8,
                  HTML(paste("<b>Choose a file to upload.</b>",
                    ...
                    "<u>If you have data from another datalogger</u>, you can either <a href='mailto:aaron.berdanier@gmail.com'>email Aaron</a> a file sample <i>or</i> ensure that the data file has a) only one header row, b) has a 'DateTimeUTC' column, and c) is comma separated.")),
                  br(),br(),
                  uiOutput('fileup'),
